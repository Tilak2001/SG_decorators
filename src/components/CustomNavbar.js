    ...
    <header>
      <Navbar bg="light" expand="lg" sticky="top" className="shadow-sm py-3">
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              <Nav.Link as={Link} to="/home" className="fw-semibold text-dark mx-2">
                Home
              </Nav.Link>

              <NavDropdown title="Decoration" id="decoration-dropdown" className="fw-semibold mx-2">
                <NavDropdown.Item as={Link} to="/decoration/marriage" className="d-flex align-items-center">
                  <FaRing className="me-2 text-warning" /> Marriage
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} to="/decoration/haldi" className="d-flex align-items-center">
                  <FaHeart className="me-2 text-danger" /> Haldi
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} to="/decoration/birthday" className="d-flex align-items-center">
                  <FaBirthdayCake className="me-2 text-info" /> Birthday
                </NavDropdown.Item>
                <NavDropdown.Item as={Link} to="/decoration/babyshower" className="d-flex align-items-center">
                  <FaBaby className="me-2 text-success" /> Baby Shower
                </NavDropdown.Item>
              </NavDropdown>

              <Nav.Link as={Link} to="/about" className="fw-semibold text-dark mx-2">
                About
              </Nav.Link>
            </Nav>
            ...
            <Nav.Link as={Link} to="/contact" className="ms-3">
